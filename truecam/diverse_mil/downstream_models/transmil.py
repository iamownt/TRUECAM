# copyright from https://github.com/lucidrains/nystrom-attention/blob/main/nystrom_attention/nystrom_attention.py
# copyright from https://github.com/szc19990412/TransMIL/tree/main/models
import torch
...
class TransMIL(nn.Module):
    def __init__(self, n_classes, embed_dim):
        ...
        self._fc1 = nn.Sequential(nn.Linear(embed_dim, hidden_dim), nn.PReLU())
    ...
    def forward(self, h, **kwargs):
        ...
        # ---->predict
        logits = self.classifier(h, **kwargs)  # [B, n_classes]
...
if __name__ == "__main__":
    ...
    model = TransMIL(embed_dim=512, n_classes=3)
