...
def get_finetune_params():
    ...
    # task settings
    parser.add_argument('--task_cfg_path',  type=str, default='../finetune/task_configs/nsclc.yaml', help='Path to the task configuration file')
    parser.add_argument('--exp_name',       type=str, default='', help='Experiment name')
    parser.add_argument('--pat_strat',      action='store_true', default=False, help='Patient stratification')

    # input data settings
    parser.add_argument('--dataset_csv',    type=str, default='../dataset_csv/nsclc/nsclc_labels_one_run.csv', help='Dataset csv file')
    ...
    parser.add_argument('--root_path',      type=str, default='/home/user/sngp/project/destination_20X/h5file', help='The tile encodings path')
    ...
    parser.add_argument('--pretrained',     type=str, default='/home/user/.cache/slide_encoder.pth', help='Pretrained GigaPath slide encoder')
    ...
    parser.add_argument('--start_folds',          type=int, default=0, help='start folds')
    ...
    parser.add_argument('--save_dir',       type=str, default='/home/user/wangtao/prov-gigapath/prov-gigapath/outputs/tcga', help='Save directory')
    ...
    parser.add_argument('--gaussian_process',      action='store_true', default=False, help='Use gaussian process')
    parser.add_argument('--evaluate_only',      action='store_true', default=False, help='Evaluate only')
    parser.add_argument('--ood_dataset_name', type=str, default=None, choices=[None, "ucs", "uvm", "blca", "acc", "unified"], help='OOD dataset name')
    parser.add_argument('--mask_tile', action='store_true', help='whether to mask the tiles')
    parser.add_argument('--mask_tile_category', type=str, default="in_slide",
                        choices=["in_slide"], help='whether to mask the tiles')
    parser.add_argument('--mask_tile_threshold', type=convert_threshold, default=0.4, help='mask tile threshold')
    parser.add_argument('--mask_pkl_path', type=str, default='/home/user/sngp/UniConch/models/ambpkl/newambk/conch_itest_ambiguity_dict_autogluon_0.2_tuning0.pkl', help='mask tile pkl path')
